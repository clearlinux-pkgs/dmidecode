...
Source0  : https://download-mirror.savannah.gnu.org/releases/dmidecode/dmidecode-3.6.tar.xz
Source1  : https://download-mirror.savannah.gnu.org/releases/dmidecode/dmidecode-3.6.tar.xz.sig
...
%setup -q -n dmidecode-3.6
cd %{_builddir}/dmidecode-3.6
%patch -P 1 -p1
pushd ..
cp -a dmidecode-3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713972188
